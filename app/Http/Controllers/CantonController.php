...
class CantonController extends Controller
{
    public function Index(){
        ...
        return view('canton.index',['cantones'=>$cantones]);
    }

    public function CrearCanton(){
    ...
    public function EditarCanton($id){
    ...
    public function GuardaCanton(Request $r){
    ...
    public function UpdateCanton(Request $r){
    ...
    public function DeleteCanton(Request $r){
