<div>
    <h4>Crear Guia de Remisión</h4>
</div>

<form class="form-row" id="gr_form" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-3">
        <label for="numguia">Numero Guia Remision</label>
        <input name="numguia" type="text" data-id="" class="form-control" maxlength="40" id="numguia" aria-describedby="emailHelp" placeholder="" value="">
    </div>
    <div class="form-group col-md-3">
        <label for="numautorizacion">Num.Autorización</label>
        <input name="numautorizacion" type="text" data-id="" class="form-control" maxlength="40" id="numautorizacion" aria-describedby="emailHelp" placeholder="" value="">
    </div>
        ...
        <div class="form-group mb-0 col-md-2" data-select6-id="6">
            ...
            <select class="js-basic-single form-control" id="idmotivo" name="idmotivo" data-select6-id="1" tabindex="-1" aria-hidden="true">
                @foreach ($motivos as $mot)
                    <option value="{{ $mot->IDMOTIVOGUIA }}" data-select6-id="1">{{ $mot->NOMBRE }}</option>
                @endforeach                             
            </select>
        </div>
        <div class="form-group mb-0 col-md-6" data-select6-id="6">
            <label>Repartidor</label>
            <select class="js-basic-single form-control" id="idrepartidor" name="idrepartidor" data-select6-id="1" tabindex="-1" aria-hidden="true">
                @foreach ($repartidores as $repar)
                    <option value="{{ $repar->IDUSUARIO }}" data-select6-id="1">{{ $repar->NOMBRE }} , {{$repar->VEHICULO}}[{{$repar->PLACA}}]</option>
                @endforeach                             
            </select>
        </div>
        <div class="form-group mb-0 col-md-2" data-select6-id="6">
    ...
    <div class="form-group col-md-12 mt-3">
        <button id="save_btn_gr" type="submit" class="btn btn-primary mb-2">Guardar</button>
    </div> 
...
<script>
    ...
    $('#save_btn_ncr__rt').on('click',function(e){
    ...
    $("form#gr_form").submit(function(e) {
                ...
                success: function (data) {
                    ...
                    {                       
                        swal({
                            position: 'top-end',
                            type: 'success',
                            title: 'Guia de Remisión Guardada',
                            text:data.message,
                            showConfirmButton: false,
                            timer: 1200
                        })                      
                        ...
                        swal({
                            position: 'top-end',
                            type: 'error',                          
                            title: 'Error al guardar guia de Remisión',
                            text:data.message,
                            showConfirmButton: false,
                            timer: 3200
                        }) 
